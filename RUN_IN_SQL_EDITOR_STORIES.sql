...
SELECT 'LPU is basically a small city with its own ecosystem and PROBLEMS',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 892
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'The REAL reason South Indians come to LPU - Instagram mountains, not education',
...
'funny', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1247
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'LPU placement reality: The 8 LPA scam they dont tell you about',
...
'placement_experience', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 2341
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Confession: I spent more on Phagwara "chai" than on textbooks',
...
'confession', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1893
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'LPU hostel: 75% attendance policy means we became expert liars',
...
'hostel_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1567
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'The Ashok Mittal cult and why we are all just revenue streams',
...
'other', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 2156
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'How LPU students explain their college to relatives',
...
'funny', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 3421
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'LPU One View vs Reality - A tragedy in screenshots',
...
'funny', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 2567
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Things you can buy with LPU 4-year fees vs what you actually get',
...
'funny', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 4123
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'I applied to 47 companies from LPU, got rejected from 46, here is what I learned',
...
'confession', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 2891
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'I lied to my parents about LPU for 4 years and I feel terrible',
...
'confession', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 5678
FROM colleges c WHERE c.short_name = 'LPU' LIMIT 1;

-- CU Stories
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'CU is LPU with better marketing and stricter parents (admin)',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1345
FROM colleges c WHERE c.short_name = 'CU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'The MMS scandal aftermath: How CU handled it like champions (of PR)',
...
'confession', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 3456
FROM colleges c WHERE c.short_name = 'CU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Why I recommend CU: Location. Only location. Thats it.',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1678
FROM colleges c WHERE c.short_name = 'CU' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Chandigarh University literally saved my life and I mean it',
...
'confession', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 8901
FROM colleges c WHERE c.short_name = 'CU' LIMIT 1;

-- Chitkara Stories
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Chitkara: The only university where your parents get more updates than you',
...
'hostel_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 987
FROM colleges c WHERE c.short_name = 'Chitkara' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Chitkara placement: Good if you want to go abroad, trash if you want India',
...
'placement_experience', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 756
FROM colleges c WHERE c.short_name = 'Chitkara' LIMIT 1;

-- GTU Story
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'GTU: Where 5 lakh students share one website that crashes every exam',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 2345
FROM colleges c WHERE c.short_name = 'GTU' LIMIT 1;

-- Parul Story
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Parul University: Vadodara fever dream',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 567
FROM colleges c WHERE c.short_name = 'Parul' LIMIT 1;

-- Marwadi Story
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Marwadi University: Gujarati business family values applied to education',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 432
FROM colleges c WHERE c.short_name = 'Marwadi' LIMIT 1;

-- MUJ Stories
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'MUJ: Paying Manipal fees for Jaipur education',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1234
FROM colleges c WHERE c.short_name = 'MUJ' LIMIT 1;

INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'MUJ hostel life: South Delhi kids discovering real India',
...
-- Thapar Story
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Thapar: The only good college in Punjab and we never let anyone forget it',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1789
FROM colleges c WHERE c.short_name = 'Thapar' LIMIT 1;

-- Nirma Story
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'Nirma: Gujaratis flexing on other Gujaratis since 2003',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 1456
FROM colleges c WHERE c.short_name = 'Nirma' LIMIT 1;

-- MDU Story
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'MDU: Government college struggles with haryanvi twist',
...
'campus_life', c.id, '00000000-0000-0000-0000-000000000000'::uuid, 'published', 876
FROM colleges c WHERE c.short_name = 'MDU' LIMIT 1;

-- RGPV Story
INSERT INTO college_stories (title, content, category, college_id, user_id, status, upvote_count)
SELECT 'RGPV: 4 lakh students, 1 broken website, infinite frustration',
...
-- Done! Check total stories
SELECT COUNT(*) as total_new_stories FROM college_stories WHERE user_id = '00000000-0000-0000-0000-000000000000'::uuid;
